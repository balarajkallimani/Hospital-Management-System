...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
      {/* Login Card */}
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-8 md:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-2">Sign in to manage your medical services</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <Link to="/forgot-password" className="text-xs text-primary hover:text-primary-dark transition font-medium">
                Forgot Password?
              </Link>
            </div>
            <input
