...
function AdminDashboard() {
  ...
  // Mock Admin Metrics
  const metrics = [
    { title: 'Total Doctors', count: '12', color: 'bg-primary/10 text-primary border-primary/20', path: '/doctors' },
    { title: 'Total Patients', count: '1,420', color: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20', path: '/patients' },
    { title: 'Receptionists', count: '4', color: 'bg-amber-500/10 text-amber-400 border-amber-500/20', path: '/doctors' },
    { title: 'System Alerts', count: '0', color: 'bg-rose-500/10 text-rose-400 border-rose-500/20', path: '/reports' }
  ];
